    ...
    def __init__(self):
        ...
        for filename, data in self.plot_heatmap_data.items():
            ...
            if "sample_distance_matrix" in filename.lower():
                if "isomirs" in filename.lower():
                    pconfig["id"] = "miRNA_sample_distance_matrix"
                elif "deseq2" in filename.lower():
                    pconfig["id"] = "non-miRNA_sample_distance_matrix"
                ...
                if "isomirs" in filename.lower():
                    pconfig["id"] = "miRNA_sample_similarity_matrix"
                elif "deseq2" in filename.lower():
                    pconfig["id"] = "non-miRNA_sample_similarity_matrix"
            ...
            if "deseq2" in filename.lower():
                section_description += (" The similarities were calculated using Log2 values "
                                        "of normalized read counts of genes using "
        ...
        for filename, data in self.plot_pca_data.items():
            ...
            if 'pca_plot' in filename.lower():
                if "isomirs" in filename.lower():
                    pconfig["id"] = "miRNA_sample_pca_plot"
                elif "deseq2" in filename.lower():
                    pconfig["id"] = "non-miRNA_sample_pca_plot"
                ...
                if "isomirs" in filename.lower():
                    pconfig["id"] = "miRNA_sample_mds_plot"
                elif "deseq2" in filename.lower():
                    pconfig["id"] = "non-miRNA_sample_mds_plot"
